...
bool LGGContactSets::hasFriendColorThatShouldShow(const LLUUID& friend_id, ELGGCSType type, LLColor4& color)
{
    ...
    static LLCachedControl<bool> fsContactSetsColorizeNearby(gSavedSettings,"FSContactSetsColorizeNearby", false);
    ...
    switch (type)
    {
        ...
        case LGG_CS_TAG:
            ...
            break;
        case LGG_CS_NEARBY:
            if (!fsContactSetsColorizeNearby)
                return false;
            break;
        case LGG_CS_MINIMAP:
