...
// [SL:KB] - Patch: Viewer-CrashReporting | Checked: 2010-11-16 (Catznip-2.6.0a) | Added: Catznip-2.4.0b
        ...
        {
            // and make sure it's initialised if not
            gDebugInfo["LoginName"] = "anon";
        }
// [/SL:KB]                                                                             
        ...
        std::string per_account_settings_file = gDirUtilp->getExpandedFilename(LL_PATH_PER_SL_ACCOUNT, LLAppViewer::instance()->getSettingsFilename("Default", "PerAccount"));
        gSavedSettings.setString("PerAccountSettingsFile", per_account_settings_file);
        gDebugInfo["PerAccountSettingsFilename"] = per_account_settings_file;
