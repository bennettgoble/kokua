/** 
 * @file llfloateradvancedbuildoptions.h
 * @brief LLFloaterAdvancedBuildOptions class definition
 *
...
#ifndef LL_LLFLOATERADVANCEDBUILDOPTIONS_H
#define LL_LLFLOATERADVANCEDBUILDOPTIONS_H
