...
const U32 AGENT_CONTROL_MBUTTON_SCROLL_DOWN = 0x4 << CONTROL_LBUTTON_DOWN_INDEX;    // 0x20000000
const U32 AGENT_CONTROL_MBUTTON_SCROLL_UP   = 0x4 << CONTROL_LBUTTON_UP_INDEX;      // 0x20000000
const U32 AGENT_CONTROL_RBUTTON_DOWN        = 0x2 << CONTROL_LBUTTON_DOWN_INDEX;    // 0x20000000
const U32 AGENT_CONTROL_RBUTTON_UP          = 0x2 << CONTROL_LBUTTON_UP_INDEX;      // 0x20000000
const U32 AGENT_CONTROL_MBUTTON_DOWN        = 0x3 << CONTROL_LBUTTON_DOWN_INDEX;    // 0x20000000
const U32 AGENT_CONTROL_MBUTTON_UP          = 0x3 << CONTROL_LBUTTON_UP_INDEX;      // 0x20000000
